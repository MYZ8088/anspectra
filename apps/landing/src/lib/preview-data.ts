...
export const PREVIEW_COMPETITOR_PROVIDERS: Record<string, string[]> = {
	HubSpot: ["doubao", "deepseek", "qwen"],
	Salesforce: ["doubao", "hunyuan", "qwen"],
	"Adobe Marketo": ["deepseek", "hunyuan"],
	Mailchimp: ["doubao", "deepseek", "qwen"],
	ActiveCampaign: ["doubao", "hunyuan", "qwen"],
	Pardot: ["deepseek", "hunyuan"],
} as const;
