---
title: Local Setup
description: Run the full AnswerLoom stack on your own machine for the fastest setup, interactive provider auth, and manual prompt runs.
---
...
## Why AnswerLoom uses UI collection

AnswerLoom does not rely on official model APIs for provider collection.
...
AnswerLoom uses [Camoufox](https://github.com/daijro/camoufox), an anti-fingerprint Firefox-based browser, because plain Chrome or Chromium automation is much more likely to run into:
